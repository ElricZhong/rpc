...
import com.elric.rmi.zookeeper.common.Constants;
...
public class ServiceProvider {
    ...
    private void createNode(ZooKeeper zk, String url) {
        try {
            ...
            String path = zk.create(Constants.ZK_PROVIDER_PATH, data, ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL); // 创建一个临时性且有序的 ZNode
